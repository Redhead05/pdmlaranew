                ...
                <div class="card-body p-4">
                    ...
                    <div class="default-table-area all-products">
                        <div class="table-responsive">
                            <table id="home-table" class="display table align-middle" style="width:100%">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Title</th>
...
{{--                                                <a href="{{ route('admin.home.detail', $item->slug) }}" class="ps-0 border-0 bg-transparent lh-1 position-relative top-2" data-bs-toggle="tooltip" data-bs-title="Detail">--}}
...
{{--                                                </button>--}}
{{--                                                @include('menu.admin.home.edit', ['item' => $item])--}}
                                                <button type="button"
...
{{--                                                @include('menu.admin.home.delete')--}}
                                            </div>
                                        </td>
                                    </tr>
{{--                                @endforeach--}}
    ...
    <script src="//cdn.datatables.net/2.3.4/js/dataTables.min.js"></script>
            <script>
                $(document).ready(function () {
                    const table = $('#home-table').DataTable({
                        responsive: true,
                        pageLength: 10,
                        columnDefs: [
