...
{{--                                                <a href="{{ route('admin.Gallery.detail', $item->slug) }}" class="ps-0 border-0 bg-transparent lh-1 position-relative top-2" data-bs-toggle="tooltip" data-bs-title="Detail">--}}
...
{{--                                                </button>--}}
{{--                                                @include('menu.admin.Gallery.edit', ['item' => $item])--}}
                                                <button type="button"
...
{{--                                                @include('menu.admin.Gallery.delete')--}}
                                            </div>
                                        </td>
                                    </tr>
{{--                                @endforeach--}}
