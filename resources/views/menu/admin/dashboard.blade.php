...
@section('title', 'Home - Landing Page Dashboard')
@section('content')
                    ...
                    <div class="col-xxl-6">
                        <div class="card bg-primary border-0 rounded-3 welcome-box style-two mb-4 position-relative">
                            <div class="card-body py-38 px-4">
                                <div class="mb-5">
                                    <h3 class="text-white fw-semibold">Welcome Back again Landing Page, <span class="text-danger-div">Olivia!</span></h3>
                            ...
                            <img src="{{ asset ('assets/images/welcome-2.gif')}}" class="welcome-2 d-none d-sm-block" alt="welcome">
                        </div>
                    </div>
                    <div class="col-xxl-6">
                        <div class="row justify-content-center">
                                        ...
                                        <table class="table align-middle border-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="instructors.html" class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset ('assets/images/user-25.jpg')}}" class="wh-44 rounded-circle" alt="user">
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="instructors.html" class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset ('assets/images/user-26.jpg')}}" class="wh-44 rounded-circle" alt="user">
                                                        </div>
                                                        <div class="flex-grow-1 ms-2 position-relative top-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="instructors.html" class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset ('assets/images/user-27.jpg')}}" class="wh-44 rounded-circle" alt="user">
                                                        </div>
                                                        <div class="flex-grow-1 ms-2 position-relative top-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="instructors.html" class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset ('assets/images/user-28.jpg')}}" class="wh-44 rounded-circle" alt="user">
                                                        </div>
                                                        <div class="flex-grow-1 ms-2 position-relative top-2">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex">
                                                                <a href="my-profile.html">
                                                                    <img src="{{ asset ('assets/images/user-30.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-31.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-32.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex">
                                                                <a href="my-profile.html">
                                                                    <img src="{{ asset ('assets/images/user-33.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-34.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-35.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <a href="project-list.html" class="flex-grow-1 ms-2 position-relative top-2">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex">
                                                                <a href="my-profile.html">
                                                                    <img src="{{ asset ('assets/images/user-36.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-37.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-38.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <a href="project-list.html" class="flex-grow-1 ms-2 position-relative top-2">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex">
                                                                <a href="my-profile.html">
                                                                    <img src="{{ asset ('assets/images/user-39.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-40.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-41.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <a href="project-list.html" class="flex-grow-1 ms-2 position-relative top-2">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0">
                                                            <div class="d-flex">
                                                                <a href="my-profile.html">
                                                                    <img src="{{ asset ('assets/images/user-25.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-28.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                                                                <a href="my-profile.html" class="ms-m-20">
                                                                    <img src="{{ asset ('assets/images/user-31.jpg')}}" class="wh-44 rounded-circle border border-2 border-color-white" alt="user">
                                                                </a>
                        ...
                        <div class="card bg-white border-0 rounded-3 mb-4">
                            <div class="card-body p-4">
                                ...
                                <div class="text-center" style="margin: 43px 0;">
                                    <div id="enrolled_by_countries_map"></div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="course-details.html">Cybersecurity Awareness</a>
                                        </td>
                                        <td>Technology</td>
                                        <td>
                                            <a href="instructors.html" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/user-42.jpg')}}" class="wh-34 rounded-circle" alt="user">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="instructors.html" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/user-43.jpg')}}" class="wh-34 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="course-details.html">Big Data Analytics</a>
                                        </td>
                                        <td>Health and Wellness</td>
                                        <td>
                                            <a href="instructors.html" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/user-44.jpg')}}" class="wh-34 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="course-details.html">Introduction to Blockchain</a>
                                        </td>
                                        <td>Education</td>
                                        <td>
                                            <a href="instructors.html" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/user-45.jpg')}}" class="wh-34 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="course-details.html">Network Administration</a>
                                        </td>
                                        <td>Food and Cooking</td>
                                        <td>
                                            <a href="instructors.html" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/user-46.jpg')}}" class="wh-34 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="instructors.html" class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/user-47.jpg')}}" class="wh-34 rounded-circle" alt="user">
                                                </div>
                                                <div class="flex-grow-1 ms-2 position-relative top-1">
                                ...
                                <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination mb-0 justify-content-center">
                                            ...
                                            <li class="page-item"><a class="page-link active" href="lms.html">1</a></li>
                                            <li class="page-item"><a class="page-link" href="lms.html">2</a></li>
                                            <li class="page-item"><a class="page-link" href="lms.html">3</a></li>
                                            <li class="page-item"><a class="page-link" href="lms.html">4</a></li>
                                            <li class="page-item">
                                                <a class="page-link icon" href="lms.html" aria-label="Next">
                                                    <i class="material-symbols-outlined">keyboard_arrow_right</i>
                                                </a>
                                    ...
                                    <div class="card bg-card-bg-c bg-primary border-0 rounded-3 mb-4 overflow-hidden position-relative">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/courses-1.jpg')}}" class="wh-130-113 rounded-3" alt="courses">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                        ...
                                        <img src="{{ asset ('assets/images/shape.png')}}" class="position-absolute top-0 end-0" alt="shape">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card bg-card-bg-c bg-primary border-0 rounded-3 mb-4 overflow-hidden position-relative">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset ('assets/images/event-5.jpg')}}" class="wh-130-113 rounded-3" alt="courses">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
