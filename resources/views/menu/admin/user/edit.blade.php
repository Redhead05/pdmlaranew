                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nia" name="nia" value="{{ old('nia', $user->nia) }}" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="gender" name="gender" required>
                                        ...
                                        <option value="L" {{ (old('gender', $user->detail?->gender) == 'L') ? 'selected' : '' }}>Male</option>
                                        <option value="P" {{ (old('gender', $user->detail?->gender) == 'P') ? 'selected' : '' }}>Female</option>
                                    </select>
                                </div>
