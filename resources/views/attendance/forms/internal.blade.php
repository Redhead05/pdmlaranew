                    ...
                    <div class="contact-us-form ms-xl-4 mx-auto text-center glass-card">
                        ...
                        <form id="attendance-sign-form" method="POST" action="{{ route('attendance.submit', $attendance) }}" class="mx-auto" style="max-width:900px;">
                            ...
                            <div class="form-group mb-3 text-start">
                                <label for="name" class="label text-secondary fw-semibold">Name</label>
                                <input type="text" name="name" id="name" class="form-control form-control-lg bg-transparent" value="{{ old('name') }}" placeholder="Your Name" required style="height:56px; font-size:1rem;">
                            </div>

                            <div class="form-group mb-3 text-start">
                                <label for="email" class="label text-secondary fw-semibold">Email (Optional)</label>
                                <input type="email" name="email" id="email" class="form-control form-control-lg bg-transparent" value="{{ old('email') }}" placeholder="email@example.com" style="height:56px; font-size:1rem;">
                            </div>
