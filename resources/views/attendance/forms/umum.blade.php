                        ...
                        <form id="attendance-sign-form" method="POST" action="{{ route('attendance.submit', $attendance) }}" class="mx-auto" style="max-width:900px;">
                            ...
                            <div class="row g-3 mb-3 text-start">
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-control-lg bg-transparent" value="{{ old('name') }}" placeholder="Nama Anda" required style="height:56px; font-size:1rem;">
                                </div>
