...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('menu.admin.category.index', compact('categories'));
    }
    ...
    {
        return view('menu.admin.category.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('menu.admin.category.show', compact('category'));
    }
    ...
    {
        $category = Category::findOrFail($id);
        return view('menu.admin.category.edit', compact('category'));
    }
